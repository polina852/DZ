      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button 
            ...
            size="sm"
            onClick={() => {
              // Logique d'export réelle
              const exportData = {
                title: 'Rapport d\'Impact Législatif',
                date: new Date().toLocaleDateString('fr-FR'),
                summary: 'Analyse des impacts des nouvelles législations',
                data: 'Données détaillées des rapports d\'impact'
              };
              ...
              alert('✅ Rapport d\'impact législatif exporté avec succès !');
            }}
          >
                    ...
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      <div className="flex justify-center gap-1">
                        ...
                        <Button 
                          ...
                          size="sm"
                          onClick={() => {
              alert(`📥 TÉLÉCHARGEMENT INITIÉ\n\nDocument: Détails du changement ${change.id}\nFormat: PDF\nTaille: ~2.3 MB\n\nLe téléchargement va commencer dans quelques secondes...`);
            }}
                        >
